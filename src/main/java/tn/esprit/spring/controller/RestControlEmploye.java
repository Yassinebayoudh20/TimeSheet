...
import tn.esprit.spring.mapstruct.mappers.ContratMapper;
import tn.esprit.spring.mapstruct.mappers.EmployeMapper;
...
public class RestControlEmploye {
	...
	public int ajouterContrat(@RequestBody ContratDTO contratDTO) {
		Contrat contrat = contratMapper.contratDTOToContrat(contratDTO);
