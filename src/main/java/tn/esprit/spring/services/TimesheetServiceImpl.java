...
import tn.esprit.spring.config.EmployeeLogging;
...
public class TimesheetServiceImpl implements ITimesheetService {
	...
	public void affecterMissionADepartement(int missionId, int depId) {
		...
		if(missionOptional.isPresent() && departementOptional.isPresent()){
	...
	public void validerTimesheet(int missionId, int employeId, Date dateDebut, Date dateFin, int validateurId) {
		...
		{ 
			Employe emp=validateur.get();
			Mission miss = mission.get();
		if(!emp.getRole().equals(Role.CHEF_DEPARTEMENT)){
...
//
		...
		logger.info(dateFormat.format(timesheet.getTimesheetPK().getDateDebut()));
		}
	}
